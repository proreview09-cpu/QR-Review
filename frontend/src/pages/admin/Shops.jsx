          ...
          <tbody className="divide-y divide-gray-200">
            {shops.map((shop) => (
              <tr key={shop._id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm text-gray-600">{shop.category?.name || <span className="text-gray-400 italic">No category</span>}</td>
            ...
            {shops.length === 0 && (
              <tr><td colSpan={7} className="px-6 py-8 text-center text-gray-500">No shops yet. Add your first shop!</td></tr>
            )}
          </tbody>
        </table>
      </div>
